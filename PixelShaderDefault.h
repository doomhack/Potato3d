...
namespace P3D
{
    template<const unsigned int render_flags> class PixelShaderDefault
    {
        ...
        static void DrawScanlinePixelLinearPair(pixel* fb, z_val *zb, const z_val zv1, const z_val zv2, const pixel* texels, const fp u1, const fp v1, const fp u2, const fp v2)
        {
        ...
        static void DrawScanlinePixelLinearHighByte(pixel *fb, z_val *zb, const z_val zv, const pixel* texels, const fp u, const fp v)
        {
            if constexpr (render_flags & ZTest)
            {
                if(*zb <= zv)
        ...
        static void DrawScanlinePixelLinearLowByte(pixel *fb, z_val *zb, const z_val zv, const pixel* texels, const fp u, const fp v)
        {
            if constexpr (render_flags & ZTest)
            {
                if(*zb <= zv)
